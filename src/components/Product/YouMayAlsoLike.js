...
function YouMayAlsoLike() {
  ...
  return (
    <div className="mb-[20px] screen1:w-[1300px] w-[94%] mx-auto flex">
      <div className="screen1:w-[99%] w-[100%] screen8:h-[500px] h-[] flex items-center rounded-[5px] bg-[#fff] mx-auto shadow-[0_0_2px_0_#00000025] pt-[15px]">
        <div className="w-full">
          {/* title */}
          <div className="flex justify-between items-center pb-[20px] screen7:px-[20px] px-[10px]">
          ...
          {/* product */}
          <div className="w-full flex overflow-hidden screen7:px-[20px] px-[10px]">
            <Slider
              {...settings1}
